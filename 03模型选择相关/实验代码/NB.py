...
# 标准缩放-归一化
# mm = MinMaxScaler()
# x_train = mm.fit_transform(np.array(x_train))
# x_test = mm.transform(np.array(x_test))
# print('数据归一化结束')
# 标准缩放-标准化
# std = StandardScaler()
...
# x_train = var.fit_transform(np.array(x_train))
# x_test = var.transform(np.array(x_test))
# print('方差选择结束')
# 数据降维-主成分分析
